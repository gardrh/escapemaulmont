...
const script = {
  no: [
    ...
    { renaud:"img/renaud6.png", cls:"",
      ...
      answers:["samick"], hints:["Pianoet står i baren i første etasje.","Se etter merkenavnet på selve instrumentet."] },
    { renaud:"img/renaud7.png", cls:"",
      ...
      answers:["1","én","en"], hints:["Boken som forteller om dette ligger ved peisen.","Svaret er et svært lavt tall."] },
  ...
  en: [
    ...
    { renaud:"img/renaud6.png", cls:"",
      ...
      answers:["samick"], hints:["The piano is in the bar on the ground floor.","Look for the brand name on the instrument itself."] },
    { renaud:"img/renaud7.png", cls:"",
      ...
      answers:["1","one"], hints:["The book that tells you about this is by the fireplace.","The answer is a very low number."] },
    { renaud:"img/renaud8.png", cls:"",
  ...
  fr: [
    ...
    { renaud:"img/renaud6.png", cls:"",
      ...
      answers:["samick"], hints:["Le piano se trouve dans le bar au rez-de-chaussée.","Cherchez le nom de la marque sur l'instrument lui-même."] },
    { renaud:"img/renaud7.png", cls:"",
      ...
      answers:["1","une","un"], hints:["Le livre qui parle de cela se trouve près de la cheminée.","La réponse est un nombre très bas."] },
    { renaud:"img/renaud8.png", cls:"",
